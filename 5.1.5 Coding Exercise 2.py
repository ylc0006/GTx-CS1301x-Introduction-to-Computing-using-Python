# -*- coding: utf-8 -*-
"""
Created on Thu Aug 17 14:51:59 2017
...
singer = Artist("Taylor Swift", "Big Machine Records, LLC")

song_1 = Song("You Belong With Me", "Fearless", 2008, singer)

song_2 = Song("All Too Well", "Red", 2012, singer)

song_3 = Song("Up We Go", "Midnight Machines", 2016, 
              Artist("LIGHTS", "Warner Bros. Records Inc."))
